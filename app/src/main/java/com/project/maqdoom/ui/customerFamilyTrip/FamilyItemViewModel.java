...
public class FamilyItemViewModel {
    ...
    public final FamilyViewModelListener mListener;
    ...
    public FamilyItemViewModel(TravelCategoryResponse.Adds adds, FamilyViewModelListener listener,String user) {
    ...
    public interface FamilyViewModelListener {
