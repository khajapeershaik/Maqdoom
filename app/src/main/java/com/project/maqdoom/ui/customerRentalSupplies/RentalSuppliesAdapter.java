...
public class RentalSuppliesAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public RentalSuppliesAdapter(List<TravelCategoryResponse.Adds> travelResponseList) {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            case VIEW_TYPE_NORMAL:
                ItemCustomerRentalViewBinding blogViewBinding = ItemCustomerRentalViewBinding.inflate(LayoutInflater.from(parent.getContext()),
                        parent, false);
    ...
    public class BlogViewHolder extends BaseViewHolder implements RentalItemViewModel.GuideViewModelListener {

        private ItemCustomerRentalViewBinding mBinding;

        private RentalItemViewModel mBlogItemViewModel;

        public BlogViewHolder(ItemCustomerRentalViewBinding binding) {
        ...
        public void onBind(int position) {
            ...
            mBlogItemViewModel = new RentalItemViewModel(adds, this,userType);
