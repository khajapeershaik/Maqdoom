...
public class TouristGuideDetailsViewModel extends BaseViewModel<TouristGuideDetailsNavigator> {


    public TouristGuideDetailsViewModel(DataManager dataManager, SchedulerProvider schedulerProvider) {
