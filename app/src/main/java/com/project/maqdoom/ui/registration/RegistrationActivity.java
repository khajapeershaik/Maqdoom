...
public class RegistrationActivity extends BaseActivity<ActivityRegistrationBinding, RegistrationViewModel> implements RegistrationNavigator {
    ...
    public void register() {
        ...
        String phone = activityRegistrationBinding.etCountryCode.getText().toString().trim()+activityRegistrationBinding.etMobileNumber.getText().toString().trim();
        Log.d("PhoneNo",phone);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityRegistrationBinding.etCountryCode.setText("+" + countryCodePicker.getSelectedCountryCode());
