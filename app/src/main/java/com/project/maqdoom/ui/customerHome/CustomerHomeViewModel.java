...
public class CustomerHomeViewModel extends BaseViewModel<CustomerHomeNavigator> {
    ...
    public CustomerHomeViewModel(DataManager dataManager, SchedulerProvider schedulerProvider) {
