...
public class TouristFamilyAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            case VIEW_TYPE_NORMAL:
                ItemTouristFamilyViewBinding blogViewBinding = ItemTouristFamilyViewBinding.inflate(LayoutInflater.from(parent.getContext()),
                        parent, false);
    ...
    public void setListener(TravelFamilyAdapterListener listener) {
        this.mListener = listener;
    }

    public interface TravelFamilyAdapterListener {
    ...
    public class BlogViewHolder extends BaseViewHolder implements FamilyItemViewModel.FamilyViewModelListener {
        ...
        private FamilyItemViewModel mBlogItemViewModel;

        public BlogViewHolder(ItemTouristFamilyViewBinding binding) {
