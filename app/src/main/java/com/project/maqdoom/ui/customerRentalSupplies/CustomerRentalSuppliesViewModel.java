...
import com.project.maqdoom.ui.customerTouristGuide.TouristGuideNavigator;
...
public class CustomerRentalSuppliesViewModel extends BaseViewModel<CustomerRentalSuppliesNavigator> {

    private final MutableLiveData<List<TravelCategoryResponse.Adds>> travelListLiveData;

    public CustomerRentalSuppliesViewModel(DataManager dataManager, SchedulerProvider schedulerProvider) {
    ...
    public void fetchData() {
        ...
        getCompositeDisposable().add(getDataManager()
                .doTravelCategoryApiCall(new TravelCategoryRequest.ServerTravelCategoryRequest("WT"),userType, String.valueOf(userId))
    ...
    public void onCruiseSuppliesClick() {
        getNavigator().goToCruises();
    }
