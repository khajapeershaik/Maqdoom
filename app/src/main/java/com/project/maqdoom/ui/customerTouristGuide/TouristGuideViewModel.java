...
public class TouristGuideViewModel extends BaseViewModel<TouristGuideNavigator> {

    private final MutableLiveData<List<TravelCategoryResponse.Adds>> travelListLiveData;

    public TouristGuideViewModel(DataManager dataManager, SchedulerProvider schedulerProvider) {
    ...
    public void fetchData() {
        ...
        getCompositeDisposable().add(getDataManager()
                .doTravelCategoryApiCall(new TravelCategoryRequest.ServerTravelCategoryRequest("TG"),userType, String.valueOf(userId))
